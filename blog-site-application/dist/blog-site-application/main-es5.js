...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppComponentsBlogDashboardBlogDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var BlogDashboardComponent = /*#__PURE__*/function () {
      function BlogDashboardComponent(fb) {
      ...
      return _createClass(BlogDashboardComponent, [{
        ...
        value: function ngOnInit() {
          this.blog = this.fb.group({
            category: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern('[a-zA-Z ]*'), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(20)]],
            article: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].email, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern('^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$')]],
      ...
      return _createClass(LoginComponent, [{
        ...
        value: function OnSubmit() {
          ...
          this.blogSiteServiceService.checkUserCredentials(this.UserLogin.value).subscribe(function (data) {
            _this.blogSiteServiceService.getToken().subscribe(function (token) {
              authorization = token.jwttoken;
              _this.blogSiteServiceService.storeUserData(data.loginId, data.firstName, authorization);
            ...
            if (error.message.includes('400')) {
              _this.invalid = 'Invalid Credentials';
            } else {
              alert(error.message);
            }
          });
      ...
      return _createClass(RegisterComponent, [{
        ...
        value: function onSubmit() {
          ...
          this.blogSiteServiceService.register(userInfo).subscribe(function (data) {
            if (data.id == null) {
              _this2.message = 'User already exist';
            } else {
              _this2.message = 'detais saved';
            }
          }, function (err) {
  ...
  function srcAppServicesBlogSiteServiceServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var BlogSiteServiceService = /*#__PURE__*/function () {
      ...
      return _createClass(BlogSiteServiceService, [{
        ...
        key: "storeUserData",
        value: function storeUserData(username, firstName, authorization) {
